                    ...
                    <div class="static-content">
                        <div class="page-content">
                            <ol class="breadcrumb">                                
                                ...
                                <li class="active"><a href="#">Editar Ata</a></li>
                            </ol>
                                            ...
                                            <div class="col-md-12">
                                                <div class="panel panel-white" data-widget='{"draggable": "false"}'>
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        @endif
                                                        <form method="POST" class="grid-form" action="{{ route('confirmarEditarAta', ['id' => $ata->id]) }}">    
                                                                @csrf	
                                                                <fieldset>
                                                                    ...
                                                                    <div data-row-span="3">
                                                                        <div data-field-span="2">
                                                                            ...
                                                                            <input type="text" name="descricao" value="{{ $ata->descricao }}" required>
                                                                            </select>
                                                                        </div>

                                                                        <div data-field-span="1">
                                                                            <label>Data</label>
                                                                            <input type="date" style="border:0" name="data" value="{{ $ata->data }}" required>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div data-row-span="1">
                                                                        <div data-field-span="1">
                                                                            <label>Ata</label>
                                                                            <textarea name="ata" cols="30" rows="20" style="resize: none;" required>{{ $ata->ata }}</textarea>
                                                                        </div>
                                                                    </div>
                                                                </fieldset>
