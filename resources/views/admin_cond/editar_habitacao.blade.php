                    ...
                    <div class="static-content">
                        <div class="page-content">
                            <ol class="breadcrumb">                                
                                ...
                                <li class="active"><a href="#">Editar Habitação</a></li>
                            </ol>
                            <div class="page-heading">
                               <h1>Editar Habitação</h1>
                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="panel panel-white" data-widget='{"draggable": "false"}'>
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        @endif
                                                        <form method="POST" class="grid-form" id="formNovaHabitacao" action="{{ route('confirmarEditarHabitacao', ['id' => $habitacaoAtual->id]) }}">    
                                                                @csrf	
                                                                <fieldset>
                                                                    <legend>Dados da Habitação</legend>
                                                                    <div data-row-span="3">
                                                                        <div data-field-span="1">
                                                                            <label>Condomínio</label>
                                                                            <select name="condominio">
                                                                            @foreach ($condominios as $condominio)
                                                                                @if ($condominio->id == $habitacaoAtual->id)    
                                                                        ...
                                                                        <div data-field-span="1">
                                                                            ...
                                                                            <input type="text" name="portaria" value="{{ $habitacaoAtual->portaria }}">
                                                                        </div>
                                                                        ...
                                                                        <div data-field-span="1">
                                                                            ...
                                                                            @foreach ($tipoHabitacoes as $tipoHabitacao)
                                                                                @if ($tipoHabitacao->id == $habitacaoAtual->id_tipo)    
                                                                                    <option value="{{ $tipoHabitacao->id }}" selected>{{ $tipoHabitacao->tipo }}</option>
                                                                                @else
                                                                ...
                                                                <fieldset>
                                                                    ...
                                                                    <div data-row-span="1">
                                                                        <div data-field-span="1">
                                                                            <label>Cartão de Cidadão do Proprietário</label>
                                                                            <input type="text" name="cc" id="cc" minlength="8" maxlength="8" value="{{ $habitacaoAtual->cc }}">
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div data-row-span="3">
                                                                        <div data-field-span="1">
                                                                            <label>Nome</label>
                                                                            <input type="text" name="nome" id="nome" value="{{ $habitacaoAtual->nome }}" readonly>
                                                                        </div>
                                                                        <div data-field-span="1">
                                                                            <label>E-Mail</label>
                                                                            <input type="email" name="email" id="email" value="{{ $habitacaoAtual->email }}" readonly>
                                                                        </div>
                                                                        <div data-field-span="1">
                                                                            <label>Telefone</label>
                                                                            <input type="text" name="telefone" id="telefone" value="{{ $habitacaoAtual->telefone }}" readonly>
                                                                        </div>
                                                                    </div>
...
<script src="{{ url('assets/plugins/gridforms/gridforms/gridforms.js') }}"></script>  								<!-- Gridforms -->
    ...
    <script src="{{ url('assets/plugins/pines-notify/pnotify.min.js') }}"></script>
    <script src="https://cdn.jsdelivr.net/npm/axios/dist/axios.min.js"></script>
    <script src="{{ url('assets/js/main/adm_cond.js') }}"></script>
    </body>
</html>