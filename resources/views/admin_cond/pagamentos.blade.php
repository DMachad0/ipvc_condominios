                    ...
                    <div class="static-content-wrapper">
                        <div class="static-content">
                            <div class="page-content">
                                ...
                                <h1>Pagamentos - {{ $habitacaoAtual->portaria }} ({{ $habitacaoAtual->tipo }}) - {{ $condominioAtual->nome }}</h1><br><br>
                                ...
                                <div class="col-md-12">
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            ...
                                            <div class="col-md-3">    
                                                <a href="/novoPagamento" class="btn btn-xs btn-primary btn-raised">+ NOVO PAGAMENTO</a>
                                            </div> 
                                        </div>
