                    ...
                    <div class="static-content">
                        <div class="page-content">
                            <ol class="breadcrumb">                                
                                ...
                                <li class="active"><a href="#">Nova Habitação</a></li>
                            </ol>
                            <div class="page-heading">
                               <h1>Nova Habitação</h1>
                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="panel panel-white" data-widget='{"draggable": "false"}'>
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        @endif
                                                        <form method="POST" class="grid-form" id="formNovaHabitacao" action="{{ route('confirmarNovaHabitacao') }}">    
                                                                @csrf	
                                                                <fieldset>
                                                                ...
                                                                <fieldset>
                                                                    ...
                                                                    <div data-row-span="1">
                                                                        <div data-field-span="1">
                                                                            ...
                                                                            <input type="text" name="cc" id="cc" minlength="8" maxlength="8">
                                                                        </div>
                                                                    </div>
